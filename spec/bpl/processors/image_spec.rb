  ...
  describe "#process" do
    ...
    context "when a timeout is set" do
      ...
      it "raises a timeout exception" do
        expect { subject.process }.to raise_error BPL::Derivatives::TimeoutError
      end
    end
    ...
    #     expect(BPL::Derivatives::PersistBasicContainedOutputFileService).to receive(:call).with(kind_of(StringIO), directives)
    #     subject.process
    #   end
    # end
  end
